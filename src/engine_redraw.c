...
{
    struct PlayerInfo* player = get_my_player();
    SYNCDBG(6,"Starting for view %d, player state %s, instance %d",(int)get_local_user_state()->view_type,player_state_code_name(get_local_user_state()->work_state),(int)player->instance_num);
